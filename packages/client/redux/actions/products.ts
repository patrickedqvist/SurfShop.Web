...
export const receiveProducts = (products: Product[] | null, error?: boolean, meta?: object): Action => ({
...
export const receiveProductBySlug = (product: Product | null, error?: boolean, meta?: object): Action => ({
